...
Step1 is the first working retrieval/search slice inside the Clause repository.

It is a standalone bill-similarity app built on top of a local OpenStates PostgreSQL restore.
...
This step is the first working retrieval slice, not the finished end state.

- good for: interactive bill upload and similarity discovery
...
The detailed roadmap for pushing this toward near-exhaustive recall and much lower latency is in [`FUTURE.md`](FUTURE.md).
