...
CREATE TABLE IF NOT EXISTS toc_files (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    code_id BIGINT NOT NULL REFERENCES code_books(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS article_refs (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    code_id BIGINT NOT NULL REFERENCES code_books(id) ON DELETE CASCADE,
    toc_file_id BIGINT NOT NULL REFERENCES toc_files(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS sections (
    ...
    source_page_url TEXT NOT NULL REFERENCES source_pages(canonical_url) ON DELETE RESTRICT,
...
CREATE INDEX IF NOT EXISTS idx_sections_search_vector
...
CREATE TABLE IF NOT EXISTS section_sources (
    ...
    article_ref_id BIGINT REFERENCES article_refs(id) ON DELETE CASCADE,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    UNIQUE NULLS NOT DISTINCT (section_id, source_page_url, article_ref_id)
);
